# This file is deprecated in the new LLM-driven tool selection architecture.
# The functionality has been moved to graph.py with the new two-node approach.
...
def get_default_retrieval_tool(
    ...
    *,
    ...
    """DEPRECATED: This function is deprecated in favor of LLM-driven tool selection.
    ...
    import warnings
    warnings.warn(
        "get_default_retrieval_tool is deprecated. Use the new LLM-driven tool selection in create_agent.",
        DeprecationWarning,
        stacklevel=2
    )
...
def get_store_arg(tool: BaseTool) -> str | None:
    ...
    import warnings
    warnings.warn(
        "get_store_arg is deprecated and no longer needed with LLM-driven tool selection.",
        DeprecationWarning,
        stacklevel=2
    )
